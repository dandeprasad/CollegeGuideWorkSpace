...
@WebServlet("/svpcetImageUpload")
public class svpcetImageUpload extends HttpServlet {
...
;
		try {
			...
			while(fileItemsIterator.hasNext()){
				...
				String FilePath_upload = imgconfig.getString("img_NewsFragments3");
		...
		String val=	 "NEWS"+"_"+(dtf.format(now))+".jpg";
			...
			Jsonloc1.put("IMAGE_UPLOADED", val);
