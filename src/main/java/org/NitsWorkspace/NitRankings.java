...
@WebServlet("/NitRankings")
public class NitRankings extends HttpServlet {
	...
	//	System.out.println("Final filepath : " + absoluteFilePath);
		...
		if (functionId.equalsIgnoreCase("NIT_DATA")&& actionId.equalsIgnoreCase("NIT_RANKINGS_DATA")){   
		  ...
		  Configuration config = null;
	        ...
	        try
	        {
	          ...
	          Connection con = DriverManager.getConnection(ConnectionSpace, Db_user, Db_password);
				...
				PreparedStatement stmt=con.prepareStatement("select * from NIT_RANKINGS"); 
			...
			int inc = 0;
				while (rs.next()) {
					...
					Jsonloc1.put("RANK", RANK);
					Jsonloc1.put("COLLEGE_NAME", COLLEGE_NAME);
					Jsonloc1.put("CITY", CITY);
					Jsonloc1.put("STATE", STATE);
					Jsonloc1.put("SCORE", SCORE);
