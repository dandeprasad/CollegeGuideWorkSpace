...
public class XlsToOracle2 {  
        public static void main(String[] args) throws Exception{                
               ...
               // Class.forName ("com.mysql.jdbc.Driver"); 
                ...
                String jdbc_insert_sql = "UPDATE NIT_LIST SET CLG_IMAGES=? WHERE CLG_ID=?";
                sql_statement = conn.prepareStatement(jdbc_insert_sql);
                /* We should now load excel objects and loop through the worksheet data */
                //"C:\\Users\\mahesh.beeram\\Desktop\\xlsfile\\xls_to_oracle.xls"
                FileInputStream input_document = new FileInputStream(new File("GradleProject\\xlsToinsertScripts\\xls_to_oracle.xls"));
                /* Load workbook */
