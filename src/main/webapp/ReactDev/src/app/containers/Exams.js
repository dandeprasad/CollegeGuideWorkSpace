...
onChangedata(){
    if (this.props.ExamsReduce.stdata.theposition ==1){
...
<Row>
  ...
  <Col xs="8" sm="8" md="8" style={{display: 'inline-block',textAlign: 'center'}}>
   ...
   <h1 style={{float: 'left',marginTop:'0', textTransform:'uppercase',fontSize:'16px',fontWeight:'700',lineHeight:'36px',marginBottom: '0'}}>{Object.values(this.props.ExamsReduce.result[eachdata])[i].CLG_NAME}</h1>
   ...
   <Col xs="12" sm="12" md="12">
     <Link to={'/ExamDetails/'+Object.values(this.props.ExamsReduce.result[eachdata])[i].EXAMID} >  <h1 className = "viewdetails" style= {{marginTop:'0', textTransform:'uppercase',fontSize:'16px',fontWeight:'700',lineHeight:'36px',marginBottom:'0',padding: '10px'}} >view full details</h1></Link>
        ...
        return (
          ...
          <Col style={{borderBottom:'1px solid rgba( 0, 0, 0, 0.05 )',marginBottom: '20px'}}>
