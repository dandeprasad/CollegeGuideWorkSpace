...
{addExamDetails}
        ...
        <NavItem  >
                  <NavLink  style = {{color:'black'}}  href="#" onClick={() => this.examsSwapClick("OVERVIEW")} >OVERVIEW</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink  style = {{color:'black'}} href="#" onClick={() => this.examsSwapClick("PREPARE")}>HOW TO PREPARE</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink style = {{color:'black'}} href="#" onClick={() => this.examsSwapClick("IMPDATES")}>IMPORTANT DATES</NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink style = {{color:'black'}} href="#" onClick={() => this.examsSwapClick("RESULTS")}>RESULTS</NavLink>
                  </NavItem>
