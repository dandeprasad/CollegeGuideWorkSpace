...
import {newsSubmitReq } from "../actions/NewsArticlesAction"
...
<Link to={'/EventDetails/'+Object.values(this.props.NewsArticlesreduce.result[eachdata])[i].NEWSID} >    SEE DETAILS >> </Link>
  </h4>
