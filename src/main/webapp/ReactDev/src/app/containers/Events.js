...
condVal = false
      ...
      addEvents.push(
        <Row  style={{margin:'50px', boxShadow: 'rgb(136, 136, 136) 0px 0px 20px',borderRadius: '2px'}}  key={Object.values(this.props.EventsReducer.result[eachdata])[i].CLGID}  >
      ...
      <label>
        <FontAwesomeIcon
          ...
          size="lg"
        />
        {' '} <p style={{color: 'white'}}  >{ Object.values(this.props.EventsReducer.result[eachdata])[i].START_DATE}<span><br/></span>To <span><br/></span>{ Object.values(this.props.EventsReducer.result[eachdata])[i].END_DATE}<span><br/></span></p>
      </label><span ></span>
        ...
        <img src={ Object.values(this.props.EventsReducer.result[eachdata])[i].FEST_IMAGE} className="img-responsive festBackImg" alt="" width="100%" height="100%"/>
...
{ Object.values(this.props.EventsReducer.result[eachdata])[i].CLG_FEST_INFO}        </p>
        <h4 className="news-header"  style={{color:'#ec7d67'}}  >
    <Link to={'/EventDetails/'+Object.values(this.props.EventsReducer.result[eachdata])[i].CLGID} >    SEE MORE >> </Link>
        </h4>
        </Col>
        ...
        <Row style={{margin:'unset'}}>
          <Col xs="12" sm="12"md="12" style={{padding:'0px'}}>
          <p   style={{padding:'10px',textAlign: 'center',color:'white',fontSize: '12px'}}> { Object.values(this.props.EventsReducer.result[eachdata])[i].CLG_LOCATION} </p>
          </Col>
        </Row>
        <Row style={{margin:'unset'}}>
        ...
        <span  style={{padding:'10px',color: 'white',fontSize: '12px'}} ><label>
          <FontAwesomeIcon
            ...
            size="lg"
          />
          {' '}{ Object.values(this.props.EventsReducer.result[eachdata])[i].FEST_WEBSITE}
        </label></span>
...
<Link to={`/Events/LatestEvents`}><Button className="events-buttons events-buttons-highlight"   style={{borderRadius: '90px 0px 0px 0px'}} >All</Button></Link>
  <Link to={`/Events/Technical`}>  <Button  className="events-buttons " >TECHNICAL</Button></Link>
      <Link to={`/Events/Cultual`}>    <Button className="events-buttons">CULTURAL</Button></Link>
          <Link to={`/Events/NIT`}>     <Button className="events-buttons">NIT's</Button></Link>
    <Link to={`/Events/IIT`}>   <Button className="events-buttons">IIT's</Button></Link>
    <Link to={`/Events/DEEMED`}>   <Button className="events-buttons" style={{borderRadius: '0px 90px 0px 0px'}}>DEEMED UNIV's</Button></Link>
</div>
