...
//     }
    ...
    render() {
        return (
            ...
            <h2>    Our Mission  </h2>
            <ul>
          <li>  <p>  We want to be a bridge between students and Other side. </p>
          </li>
          <li><p>
            Our content obtained from the most authentic source, the
                ...
                <Col xs="12" sm="12" md="12">
              <p><b>For any info or queries contact us at :</b>
				dandereddyprasad@collegeexplore.in</p>
			<p><b>Developers:</b> Dande Reddy Prasad,Siva Ganesh,Damoji
				Pathivada</p>
                </Col>
</Row>
            </div>
